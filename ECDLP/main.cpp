...
int main(int argc, char* argv[])
{
    ...
    BigInt p(69234577397554139), a(0), b(7), order(69234577237507391);
    ...
    */
    BigInt p(13835058061724614657), a(0), b(20), order(13835058061724614657);
    BigInt Px(616859655854051956), Py(12065166484289278801); 
    BigInt Qx(5170466145333976578), Qy(7139090565738339416);
